...
from askanna.config.project import extract_push_target, load_config, PushTarget
...
class TestProjectConfig(unittest.TestCase):
    ...
    def test_load_project_config_file(self):
        project_config_path = 'tests/resources/projects/project-003-subdirectories/askanna.yml'
        ...
        self.assertEqual(
            config.push_target.url,
            'https://beta.askanna.eu/2Bd3-fHXM-Lf22-Xne7/project/3FtY-Bb1W-Kj1m-ZAED'
        )
    ...
    def test_load_project_config_no_push_target(self):
        project_config_path = 'tests/resources/projects/project-001-simple/askanna.yml'
